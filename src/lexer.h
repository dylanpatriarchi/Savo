...
typedef enum {
    ...
    TK_TRIM, TK_SUBSTR, TK_INDEXOF, TK_REPLACE, TK_SPLIT, TK_JOIN,
    TK_POP, TK_CONTAINS, TK_KEYS, TK_INPUT, TK_FOREACH,
    TK_MAP, TK_FILTER, TK_REDUCE, TK_SORT,
    TK_IF, TK_ELIF, TK_ELSE, TK_END, TK_WHILE, TK_FOR, TK_DEF, TK_RETURN,
    TK_BREAK, TK_CONTINUE, TK_ASSERT,
    TK_PUSH, TK_SET,
